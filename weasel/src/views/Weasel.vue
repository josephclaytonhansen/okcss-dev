                ...
                <section id = "weasel-events-content" class = "col-12" v-if="current_tab==='events'">
                    ...
                    <div class = "events">
                        ...
                        <div v-for="(event, index) in events" class = "row flex-between col-12 event wrap-t">
                            ...
                            <div class = "col-2 event-organization col-shrink fwc"><p><select v-model="event.organization" :id = "event._id + '-organization'"><option :selected="event.organization === organization" v-for="organization in organizations">{{organization}}</option><option>Ward</option></select></p></div>
