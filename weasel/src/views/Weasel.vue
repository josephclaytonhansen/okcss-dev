    ...
    <div class="row flex-center center">
        <div class="col-8 fwc">
            ...
            <section id = "weasel-body" class="row column">
                    ...
                    <section class = "tabs" :class="ward" id="weasel-tabs">
                        <div class="tab-row row flex-between">
                            <div class="tab-row-tabs row tab-row-tabs-calendar wrap">
                                <div class="tab-row-tab tab calendar-tab" :class="{'activeTab': current_tab == 'worship'}" @click="current_tab = 'worship'">
                                ...
                                <div class="tab-row-tab tab calendar-tab" :class="{'activeTab': current_tab == 'tools'}" @click="current_tab = 'tools'">
                    ...
                    <section id = "weasel-body-content" class="row flex-center center">
