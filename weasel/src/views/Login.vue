...
const attemptLogin = () => {
    ...
    let url = 'https://localhost:5220/api/users/login'
    try{
    ...
    .catch((error) => {
        console.log(error.message || error.error || 'Error logging in')
    })
} catch (error) {
    console.log(error.message || error.error || 'Error logging in')
}
...
<template>
    <div class="row flex-center center" id = "login-container">
        <div class="col-8 fwc">
